...
public final class ItemViewBinding implements ViewBinding {
  ...
  private ItemViewBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      ...
      @NonNull TextView tvDate, @NonNull TextView tvName, @NonNull TextView tvRating) {
  ...
  public static ItemViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemViewBinding((CardView) rootView, cardView, image, ratingbar, tvAuthor, tvDate,
          tvName, tvRating);
    }
