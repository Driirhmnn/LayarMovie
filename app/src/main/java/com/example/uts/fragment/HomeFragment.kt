...
import com.example.uts.FilmClass
import com.example.uts.MovieAdapter
...
class HomeFragment : Fragment() {
    ...
    private lateinit var filmClass: List<FilmClass>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = MovieAdapter(requireContext(), filmClass) { upcoming ->
