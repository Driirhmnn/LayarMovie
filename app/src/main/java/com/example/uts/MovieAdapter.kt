...
class MovieAdapter (private val context: Context, private val novel: List<FilmClass>, val listener: (FilmClass) -> Unit)
    : RecyclerView.Adapter<MovieAdapter.NovelViewHolder>(){
